...
1. From the commandline, use the 'cd' command to navigate to the 'Install_AllUsers_LatestInRuleVersion.bat' batch file and run it.  Alternatively you can modify this command:
````
c:\Users\%USERPROFILE%\Documents\InstallationFiles v1.1 for irAuthor 5.7.2\InstallationFiles v1.1 for irAuthor 5.7.2\Install_AllUsers_LatestInRuleVersion.bat
````
